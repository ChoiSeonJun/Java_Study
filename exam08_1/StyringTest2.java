...
public class StyringTest2 {
	public static void main(String[] args) {
		...
		System.out.println("2. 특정 문자 위치:" + s.indexOf('e'));
		System.out.println("2. 특정 문자 위치:" + s.indexOf('X')); // 없으면 -1
		...
		System.out.println("7. 부분열:" + s.substring(1));	// 위치 1부터 끝까지
		System.out.println("7. 부분열:" + s.substring(1, 4));	// 위치 1부터  3까지
		...
		// 원본문자열 ==> String 문자열을 변경되지 않는다. 새로운 문자열이 생성된것이다.
